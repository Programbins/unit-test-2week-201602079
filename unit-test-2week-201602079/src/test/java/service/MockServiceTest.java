...
public class MockServiceTest {
    ...
    @Test
    public void 어떠한챔피언이름을입력해도_무조건_베인_리턴()
    {
        Champion champion = mock(Champion.class);
    ...
    @Test
    public void 어떠한포지션을입력해도_무조건_미드_리턴()
    {
        Champion champion = mock(Champion.class);
    ...
    public void shouldPassWhenNeverRunChampionSetName() {
        ...
        champion.setPosition("미드");
        champion.setHasSkinCount(3);
        verify(champion, never()).setName("조이");
    }
    ...
    @Test
    public void 리산드라를검색하면_미드가짜객체_리턴_탑_확인(){
    ...
    @Test
    public void 챔피언리스트_사이즈_확인(){
        List<Champion> champions = new ArrayList<>();
        champions.add(new Champion("티모", "탑", 4));
        champions.add(new Champion("애쉬", "바텀", 1));
        champions.add(new Champion("우디르", "정글", 2));
